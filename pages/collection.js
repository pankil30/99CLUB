...
const Collection = () => {
  return (
    <>
      <Head>
        <title>Spring Capsule Collection | Meridian</title>
      </Head>
        ...
        <div className="w-full max-w-[1400px] mx-auto">
          ...
          <div className="flex flex-col items-center text-center mb-16">
            ...
            <p className="text-gray-500 max-w-2xl text-sm md:text-base leading-relaxed">
              Discover our latest curated collection. Designed for the transitional weather, featuring lightweight fabrics, breathable knits, and timeless silhouettes that seamlessly blend comfort with sartorial elegance.
            </p>
          </div>
